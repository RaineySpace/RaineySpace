        ...
        {href ? (
          <Link href={href} aria-label={linkLabel || title} className="group/section flex min-w-0 items-baseline gap-4">
            <h2 id={headingId} className="section-title shrink-0 border-b border-[--border] pb-0.5 transition-[border-color] duration-200 ease-[ease] group-hover/section:border-[--title] group-focus-visible/section:border-[--title]">
              {title}<span aria-hidden="true" className="inline-block pl-1 transition-transform duration-200 ease-[ease] group-hover/section:translate-x-[0.1em] group-hover/section:-translate-y-[0.1em] group-focus-visible/section:translate-x-[0.1em] group-focus-visible/section:-translate-y-[0.1em] motion-reduce:!transform-none motion-reduce:transition-none">↗</span>
            </h2>
