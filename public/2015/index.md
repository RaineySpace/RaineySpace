...
title: 2015 · 走出象牙塔
date: 2015-12-31
summary: 2015年毕业实习辗转多家公司学习前端与Node成长体验创业与职场反思不足展望持续学习技术继续前行吧
tags:
  - 年鉴
---

2015年对于我来说应该是一个特殊的年份，从大学的象牙塔中走出来，是要经历一些原本想象不到的东西。就像我之前说过的，这就是成长。
...
然后有一个哥们正好被内推进了**三江购物**，而三江刚好也要招人，然后就去了三江。三江在宁波是一家很出色的企业，而他们的电商技术团队是刚刚组建的，很多从外面挖来的大牛，苏宁国美的都有，技术水平在宁波绝对的数一数二。去了以后，技术总监让我一个人写三江的移动端网站前端，要支持微信还有手机浏览器访问，并推荐我用ionic（这个坑我觉得我可以填很久很久）。因为对于这些新兴技术不是很了解，然后就花费了大概半个月的时间边做边给自己充电。这段时间我学习前端技术的效率很高很高，当然这也归功与和我的那群志同道合的朋友们，会一起讨论技术方案，讨论层出不穷的框架，看到新的东西就会一起分享，虽然也经常会因为意见不合而争吵，但是确实是打心眼儿里感激大家让我时时刻刻都在了解新技术。
...
从一个懵懵懂懂的小白晋升为一个不懵懵懂懂的小白，开始明白JS是一个什么语言，开始知道这门手艺可以做很多很多事情。而Node仿佛为我打开了新世界的大门，让我对全栈工程师有很大的兴趣，自己也正在向着这个方向努力发展。这一年中重点学习了Node、Angular、Ionic等，对React也十分感兴趣，等公司项目完成以后就要开始学习React。对于自己从事的前端行业的感觉就是爬出一个坑又掉进另一个坑里。

虽然一直用Windows平台进行开发，但是十分向往Mac OS系统的简洁，更对这个开发者极其友好的系统心生神往。曾经把电脑装成Linux系统来用过一段时间，但是各类软件对其的适配实在是说不上友好。
...
- 希望买一台Mac
- 熟练掌握Angular并习惯使用Typescript编码
- 深入学习React
- 写一个自己的CSS类库
- 每天坚持阅读一定量的英文资料
- 增加[Github](http://github.com/RaineySpace)的绿化面积
